...
class AllNewMenu extends StatefulWidget {
  const AllNewMenu({Key? key,}) : super(key: key);

  @override
  State<AllNewMenu> createState() => _AllNewMenuState();
}

class _AllNewMenuState extends State<AllNewMenu> {
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('Newly Added Menu', style: TextStyle(color: kwhite,fontSize: 20.sp),),
                      GestureDetector(
                        onTap: () {
